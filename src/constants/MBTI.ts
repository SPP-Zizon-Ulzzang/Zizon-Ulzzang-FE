...
export const MBTI_RESULT: MBTIResult[] = [
  ...
  },
  {
    ...
    tag: '#센스가득 #눈치눈치 #좋아요확인',
    description:
      '어떤 게시글이든 절대 그냥 올리지 않는 당신! 베스트 컷만 차곡차곡 모아 글도 꽉꽉 채워 업로드해요. 스토리도 마찬가지예요. 글과 스티커 가득 온 마음을 담아 업로드해요. 친구들이 스토리로 도움을 요청하면 절대 지나치지 않는 인스타 속 슈퍼맨! 하지만 미어캣처럼 사소한 것 하나하나 눈치를 보기도 해요. 지금, 이 결과를 공유하는 것도 고민 중일지도...어떤 게시글이든 절대 그냥 올리지 않아요 베스트 컷만 모아 글도 꽉꽉 채워서! 스토리 하나를 올리더라도 정성스럽게! 글로 설명도 하고 스티커도 붙이고 정성 가득. 친구들이 스토리로 도움을 요청하면 절대 지나치지 않아요! 인스타 속 슈퍼맨. 미어캣처럼 사소한 것 하나하나 눈치를 보기도 해요. 지금 이 결과를 공유하는 것조차 사람들이 좋아할까 고민할 지도..',
  },
  {
    MBTI: 'ENTJ',
    ...
    tag: '#스펙빵빵 #자아도취 #팩트폭격기',
    description:
      '진취적인 성격이 인스타에 그대로 나타나는 당신. 게시글만 봐도 멋진 아우라가 뿜뿜 뿜어져 나와요. 인스타에 올라오는 새벽 감성 글을 보면 가끔 이해가 되지 않아요...  무조건 Simple is Best. 사진은 열심히 고르지만 게시물에 글은 많이 안 써요. 가끔 성과 자랑하는 용도 외에는 거의 사용하지 않아요. 왜냐하면 인스타 할 시간이 없거든요!',
  },
  {
    MBTI: 'ISTJ',
    ...
    description:
      '비공개 계정일 확률이 99%인 당신! 혹시 지금 테스트하려고 공개로 잠깐 바꿨나요? 인스타를 원래 잘 안 하지만 팔로우도 진짜 친한 사이 아니면 잘 안 받아요. 그래도 추억 남겨두는 것을 좋아해서 일기장 용도로 인스타를 하고 있어요. 꽁꽁 숨겨 기록하는 와중에 실속 챙기기 장인이에요! 그래서 음식점에서 진행하는 인스타 이벤트는 기꺼이 참여하는 편!',
  },
  {
    MBTI: 'ISFJ',
